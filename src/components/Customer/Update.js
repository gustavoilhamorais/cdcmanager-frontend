...
class UpdateCustomers extends Component {
  ...
  handleSubmit = e => {
    ...
    if (
      ...
      !this.state.phone || !this.state.document ||
      !this.state.address
    ...
    const message = 'Cliente atualizado.'
      ...
      <div className="container col-md-7">
        <div className="card shadow mb-4">
          <div className="card-header py-4">
            <h6 className="m-0 font-weight-bold text-primary">Novo Cliente</h6>
          </div>
...
export default withRouter(UpdateCustomers);
